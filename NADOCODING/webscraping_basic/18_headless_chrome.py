...
options.add_argument("window-size=1080x1920") #동작하는 크롬 사이즈
...
# browser=webdriver.Chrome() # 헤드리스 크롬 작동(chrome_options=options)
...
print("스크롤 완료")
browser.get_screenshot_as_file("google_movie.png") # 헤드리스 크롬 동작 중 스크린샷
