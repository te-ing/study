...
initialize();
if (module.hot) {
    script.__hmrId = 'f5a8a9-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('f5a8a9-hmr', script)) __VUE_HMR_RUNTIME__.reload('f5a8a9-hmr', script);
        }, 0);
    });
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["kAaS7","i87aF"], "i87aF", "parcelRequire8a89")
